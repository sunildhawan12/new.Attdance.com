 const URL = 'https://script.google.com/macros/s/AKfycbzhR-60-AUw2gL6_8ro7Dm3arl0exFNJ0a3n0MYPE-r-s4YwLrJDkJsT31mYk9LqqG92g/exec';
    ...
    window.onload = () => {
      navigator.geolocation.getCurrentPosition(pos => {
        ...
        msg.innerHTML = "❌ Location permission denied or unavailable.<br>📱 Please allow location access in your browser settings.";
      });
    };
    ...
    async function submitAttendance(status) {
      ...
      navigator.geolocation.getCurrentPosition(async pos => {
        ...
        msg.innerHTML = "❌ Unable to get location. Please allow access.";
      });
    }